...
use Corley\Bundle\BaseBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CorleyBaseBundle:Book')->findAll();

        return $this->render('CorleyBaseBundle:Book:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CorleyBaseBundle:Book:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CorleyBaseBundle:Book')->find($id);
        ...
        return $this->render('CorleyBaseBundle:Book:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CorleyBaseBundle:Book:edit.html.twig', array(
            'entity'      => $entity,
